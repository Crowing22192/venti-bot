...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const embed = new MessageEmbed()
            ...
            .addField('<a:go_Arrow:901447773252100097> __**Nội dung cập nhật:**__', '・ Cải tiến lệnh `quemua`')
            .addField('<a:go_KannaFire:901445882606665740> **__Special Thanks:__**','・ No one...')
